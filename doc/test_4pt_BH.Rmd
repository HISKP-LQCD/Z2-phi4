...
Fit function:
$$C_4^{BH}= 8\pi(m_0+m_1) a_N \tilde{t} + 16 a_N a_N   \sqrt{ 2 \pi  (m_0+m_1)  m_0 m_1 \tilde{t} }$$
...
$$C_4^{BH}= 8\pi(m_0^2+m_1^2) a_N \tilde{t} $$
...
$$C_4^{BH}= 8\pi(m_0^2+m_1^2) P[0] \tilde{t} + 16 P[1]   \sqrt{ 2 \pi  (m_0+m_1)  m_0 m_1 \tilde{t} }$$
```{r echo=FALSE,  results="asis"}
...
$$C_4^{BH}= 8\pi(m_0^2+m_1^2) P[0] \tilde{t} + 16 P[1]   \sqrt{ 2 \pi  (m_0+m_1)  m_0 m_1 \tilde{t} }+P[2]$$
```{r echo=FALSE,  results="asis"}
